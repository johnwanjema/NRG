            ...
            <div class="col-6 col-xl-4">
                <a class="block block-link-pop text-right bg-primary" href="javascript:void(0)">
                    <div class="block-content block-content-full clearfix border-black-op-b border-3x">
                        ...
                        <div class="font-size-sm font-w600 text-uppercase text-white-op">Total Submissions</div>
                    </div>
                </a>
            </div>
            <div class="col-6 col-xl-4">
                <a class="block block-link-pop text-right bg-earth" href="javascript:void(0)">
                    <div class="block-content block-content-full clearfix border-black-op-b border-3x">
                        <div class="float-left mt-10 d-none d-sm-block">
                            <i class="si si-badge fa-3x text-earth-light"></i>
                        </div>
                        ...
                        <div class="font-size-sm font-w600 text-uppercase text-white-op">Nrg Submisions</div>
                    </div>
                </a>
            </div>
            <div class="col-6 col-xl-4">
                <a class="block block-link-pop text-right bg-elegance" href="javascript:void(0)">
                    <div class="block-content block-content-full clearfix border-black-op-b border-3x">
                        <div class="float-left mt-10 d-none d-sm-block">
                            <i class="si si-playlist fa-3x text-earth-light"></i>
                        </div>
                        <div class="font-size-h3 font-w600 text-white"><span data-toggle="countTo" data-speed="1000" data-to="2600" class="js-count-to-enabled">2600</span></div>
                        <div class="font-size-sm font-w600 text-uppercase text-white-op">Fun x Submisions</div>
                    </div>
                </a>
            </div>
            <!-- END Row #1 -->
